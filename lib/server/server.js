...
console.log("Starting Nightscout..."); // Debug line at the top
...
///////////////////////////////////////////////////
var PORT = env.PORT;
var HOSTNAME = '0.0.0.0'; // Hardcode to 0.0.0.0, ignoring env.HOSTNAME
...
require('./bootevent')(env, language).boot(function booted (ctx) {
    ...
    console.log("About to start server on", HOSTNAME, "port", PORT); // Updated debug line
