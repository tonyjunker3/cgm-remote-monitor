...
console.log("Starting Nightscout..."); // Added debug line at the top
...
require('./bootevent')(env, language).boot(function booted (ctx) {
    ...
    console.log("About to start server on", HOSTNAME || '0.0.0.0', "port", PORT); // Added debug line before listen
